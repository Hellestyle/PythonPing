...
customrip1 = os.system(lp + customip1)
customrip2 = os.system(lp + customip2)
customrip3 = os.system(lp + customip3)

ip0 = "8.8.8.8" #Internet Connectivity
rip0 = os.system(lp + ip0)

ip1 = "google.com" # Example DNS adress
rip1 = os.system(lp + ip1)

ip2 = "vpn.spectoremote.com" #SpectoRemote AS VPN adress
rip2 = os.system(lp + ip2)
